...
const departmentsData = [
  ...
  },
  {
    id: "welfare",
    title: "Welfare",
    desc: "Serving humanity through healthcare, aid, and empowerment programs — including the management of Masajid under its supervision.",
    image: FreeMedicalDispensory,
    sections: [
      {
        heading: "Overview",
        content: `
          Our Welfare Department focuses on uplifting underprivileged families and individuals 
          through various humanitarian initiatives that combine compassion, care, and empowerment.
          This department also oversees the management of multiple Masajid across Karachi.
        `,
      },
      {
        heading: "Major Welfare Initiatives",
      ...
      {
        heading: "Masajid Management",
        content: `
          The Masajid operate under the JAH as centers of worship, learning, and community development.
        `,
        list: [
          "Jamia Masjid Sufaid, Soldier Bazaar — Monthly expense: Rs. 300,000",
          "Jamia Masjid Bait-us-Salaam, Azizabad — Monthly expense: Rs. 5,000,000",
      ...
      },
      {
        ...
        list: [
          "Establish a fully equipped Medical Laboratory",
          "Set up an Eye Surgery Unit for advanced community care",
          "Install Solar Power Systems across all managed Masajid",
          "Provide R.O. Plants for clean drinking water at each Masjid",
        ],
      },
    ],
  },
